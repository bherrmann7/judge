...
(defroutes home-routes
  ...
  (GET "/a/login.html" (judge.admin/login))
  (POST "/a/login-post" (judge.admin/login-post))
  (GET "/a" req (judge.admin/admin-page req))
  (GET "/a/judges" req (judge.admin/judges-page req))
  (GET "/a/students" req (judge.admin/students-page req))
  (GET "/a/judgements" req (judge.admin/judgements-page req))
  (GET "/a/awards" req (judge.admin/awards-page))
